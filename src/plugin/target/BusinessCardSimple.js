export let BusinessCardSimple = class {
  static instance

  static getInstance() {
    return BusinessCardSimple.instance
      ? BusinessCardSimple.instance
      : (BusinessCardSimple.instance = new BusinessCardSimple())
  }
  ...
  query(q) {
    ...
    let least_match
    least_match = q.least_match == 'all' ? q.match.length : least_match
